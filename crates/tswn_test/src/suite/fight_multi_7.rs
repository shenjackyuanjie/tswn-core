...
pub fn fight_multi_7<E: crate::EngineAdapter>() {
    const FIGHT_CASE: &str = include_str!("fixtures/fight_multi_7.md");
    ...
    assert_eq!(total_score, 24208, "fight_multi_7 score mismatch");
