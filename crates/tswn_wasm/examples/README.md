...
- `show-wasm.test.mjs` 覆盖 `buildV2ReplayFromNormalizedRun()` 的纯 adapter 输出，验证 v2 normalized run 可以生成 show-compatible players / states / rows / clips / HP bar / winner row shape。
