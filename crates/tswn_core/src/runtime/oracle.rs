...
use crate::rc4::RC4;
use crate::runtime::{CombatRuntime, EntityIdx, PreparedCombatTemplate, RoundOutcome, RuntimeNormalizedRun};
...
pub fn strict_diff_runs(expected: &RuntimeNormalizedRun, actual: &RuntimeNormalizedRun) -> Result<(), StrictRunDiff> {
...
pub fn normalize_legacy_run(runner: &mut Runner, max_rounds: usize) -> RuntimeNormalizedRun {
...
pub fn run_minimal_runtime_once(template: PreparedCombatTemplate) -> NormalizedOutcome {
...
mod tests {
    ...
    #[test]
    fn strict_diff_harness_accepts_minimal_runtime_outcome() {
        let expected = minimal_1v1_expected_after_one_round(10, 10, 3);
        let actual = run_minimal_runtime_once(PreparedCombatTemplate::minimal_1v1(10, 10, 3));
