...
fn player_template_stores_registered_skill_loadout() {
    let mut builder = crate::runtime::ExtensionRegistryBuilder::default();
    let skill = builder
        .register_skill(
            "custom",
            "fire",
            "custom.fire",
            crate::runtime::TargetPolicy::Enemy,
            SkillPriority(3),
        )
...
fn skill_loadout_caches_only_builtin_action_lanes_and_invalidates_with_order() {
    ...
    let fire = builder
        .register_skill(
            "core",
            crate::runtime::BuiltinActiveSkill::Fire.local_name(),
            crate::runtime::BuiltinActiveSkill::Fire.export_name(),
            crate::runtime::TargetPolicy::Enemy,
            SkillPriority(1),
        )
        .expect("内置技能应注册成功");
    ...
    assert_eq!(cached[0].skill, crate::runtime::BuiltinActiveSkill::Fire);
...
fn entity_records_copy_registered_player_kind_flags_into_runtime() {
    ...
    let kind = builder
        .register_player_kind_with_policies(
            ...
            crate::runtime::PlayerKindPolicies::default(),
        )
    ...
    assert_eq!(runtime.policies, crate::runtime::PlayerKindPolicies::default());
}

#[test]
fn entity_records_copy_registered_player_kind_policies_into_runtime() {
    let mut builder = crate::runtime::ExtensionRegistryBuilder::default();
    let policies = crate::runtime::PlayerKindPolicies {
        owner_resolution: crate::runtime::OwnerResolutionPolicy::RootOwner,
        damage_share: crate::runtime::DamageSharePolicy::ShareToOwner,
        merge: crate::runtime::MergePolicy::FixedLane,
...
fn player_template_policy_overrides_update_runtime_policy_fields() {
    ...
    let arena = EntityArena::from_templates_with_registry(
        vec![
            PlayerTemplate::with_kind(1, "summon", kind, 0, 10, 3)
                .with_damage_share_policy(crate::runtime::DamageSharePolicy::None),
        ],
        &registry,
    );
    ...
    assert_eq!(
        ...
        crate::runtime::OwnerResolutionPolicy::RootOwner
    );
    assert_eq!(runtime.policies.damage_share, crate::runtime::DamageSharePolicy::None);
    assert_eq!(runtime.policies.merge, crate::runtime::MergePolicy::FixedLane);
...
fn entity_arena_uses_policy_overrides_when_spawning() {
    ...
    let kind = builder
        .register_player_kind_with_policies(
            ...
            crate::runtime::PlayerKindPolicies {
                owner_resolution: crate::runtime::OwnerResolutionPolicy::SelfEntity,
                damage_share: crate::runtime::DamageSharePolicy::None,
                merge: crate::runtime::MergePolicy::None,
                inherit_owner_def_res: false,
            },
        )
        .expect("kind should register");
...
fn entity_records_reserve_registered_entity_slots() {
    ...
    arena
        ...
        .unwrap()
        .slots
        .set(slot, crate::runtime::SlotValue::Bool(true))
        .unwrap();

    assert_eq!(
        arena.get(EntityIdx(0)).unwrap().slots.get(slot),
        Some(&crate::runtime::SlotValue::Bool(true))
    );
}
...
#[test]
fn state_store_tracks_runtime_state_entry_metadata_and_hook_mask() {
    let mut store = StateStore::default();
