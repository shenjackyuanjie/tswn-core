...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1v1 | `1,1` | 4978 | 20 | 80 | 441 | 62 | 1396 | 1524 |
| 2v2 | `2,2` | 5000 | 29 | 116 | 818 | 91 | 2579 | 2195 |
| 2v2v2 | `2,2,2` | 5000 | 35 | 140 | 1160 | 111 | 3610 | 2655 |
| FFA 3 | `1,1,1` | 5040 | 21 | 84 | 680 | 66 | 2130 | 1595 |
| FFA 4 | `1,1,1,1` | 5040 | 28 | 112 | 847 | 88 | 2657 | 2121 |
| FFA 5 | `1,1,1,1,1` | 5040 | 32 | 128 | 1001 | 101 | 3146 | 2418 |
| FFA 6 | `1,1,1,1,1,1` | 5040 | 37 | 148 | 1274 | 117 | 3974 | 2805 |
| FFA 7 | `1,1,1,1,1,1,1` | 5000 | 38 | 152 | 1347 | 121 | 4197 | 2886 |
| FFA 8 | `1,1,1,1,1,1,1,1` | 5000 | 40 | 160 | 1429 | 128 | 4444 | 3032 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 7v1 | `7,1` | 4987 | 23 | 92 | 852 | 77 | 2725 | 1767 |
| 6v2 | `6,2` | 5000 | 31 | 124 | 1035 | 101 | 3290 | 2358 |
| 6v1v1 | `6,1,1` | 5000 | 35 | 140 | 1128 | 112 | 3619 | 2666 |
| 5v3 | `5,3` | 5000 | 44 | 176 | 1349 | 140 | 4249 | 3335 |
| 5v2v1 | `5,2,1` | 5000 | 38 | 152 | 1252 | 122 | 3970 | 2881 |
| 5v1v1v1 | `5,1,1,1` | 5000 | 37 | 148 | 1242 | 119 | 3944 | 2809 |
| 4v4 | `4,4` | 5000 | 41 | 164 | 1423 | 131 | 4451 | 3109 |
| 4v3v1 | `4,3,1` | 5000 | 38 | 152 | 1338 | 122 | 4168 | 2886 |
| 4v2v2 | `4,2,2` | 5000 | 40 | 160 | 1429 | 128 | 4498 | 3044 |
| 4v2v1v1 | `4,2,1,1` | 5000 | 38 | 152 | 1309 | 122 | 4077 | 2883 |
| 4v1v1v1v1 | `4,1,1,1,1` | 5000 | 37 | 148 | 1268 | 119 | 3975 | 2812 |
| 3v3v2 | `3,3,2` | 5000 | 39 | 156 | 1342 | 125 | 4184 | 2959 |
| 3v3v1v1 | `3,3,1,1` | 5000 | 40 | 160 | 1362 | 128 | 4271 | 3037 |
| 3v2v2v1 | `3,2,2,1` | 5000 | 42 | 168 | 1411 | 134 | 4387 | 3191 |
| 3v2v1v1v1 | `3,2,1,1,1` | 5000 | 41 | 164 | 1435 | 131 | 4454 | 3103 |
| 3v1v1v1v1v1 | `3,1,1,1,1,1` | 5000 | 40 | 160 | 1418 | 128 | 4426 | 3031 |
| 2v2v2v2 | `2,2,2,2` | 5000 | 43 | 172 | 1481 | 137 | 4630 | 3274 |
| 2v2v2v1v1 | `2,2,2,1,1` | 5000 | 41 | 164 | 1436 | 131 | 4479 | 3114 |
| 2v2v1v1v1v1 | `2,2,1,1,1,1` | 5000 | 40 | 160 | 1366 | 128 | 4241 | 3025 |
| 2v1v1v1v1v1v1 | `2,1,1,1,1,1,1` | 5000 | 42 | 168 | 1389 | 134 | 4325 | 3190 |
...
| 容量 profile | `baseline-64`（已冻结）；变更须发布新 profile | **已冻结 `E_max=64`**，`E/T/R/H/L/S/Q/V/X = 64/32/32/512/4096/64/512/32768/65536`，逐维推导见第 4 节容量表。实测依据：100k 池（2v2v2）`e≤30`、`h≤120`、`l≤882`、`q≤96`、`V≤2800`、`X≤1671`；8 人池全部 20 种队伍划分最高 `e=44`、`h=176`、`l=1481`、`q=140`、`V=4630`、`X=3335`；3v2v2v1 深测到 `e=46`、`h=184`、`l=1560`、`q=146`、`V=4846`、`X=3489（X 列由修正前的脚本统计，含每个模板虚增 5 条计划叶子的高估，方向保守，待用修正脚本重测）`。实体数机制审计（第 4 节）确认不存在与输入无关的上界，所以 `E_max` 是**支持域选择**：8 人以内、召唤密度不超过该池。配套：`stats` 报每维溢出率，超限返回 `CapacityExceeded` 而不截断；`Q_max`／`S_max` 随 `E_max` 同步提到 512／64，`H_max` 按实测 `h≈4e` 定 512，`X_max` 每槽按第 3.2 节白名单 3 条计费（原 66 条/槽在冻结白名单下不可达）。要机制保证只能改引擎（给 shadow／clone 加记忆槽或加全局上限），会改变战斗语义，本轮不做 |
