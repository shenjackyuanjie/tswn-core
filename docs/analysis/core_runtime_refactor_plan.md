...
- `run_legacy_summon_recast_from_template_slot`、`run_shadow_minion_from_template_slot`、`run_zombie_minion_from_template_slot` 已把 summon/shadow/zombie fixture 闭包提升为正式 handler，复用 typed template slot、entity slot counter 与 legacy replay 顺序；
