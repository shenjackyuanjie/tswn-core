...
- summon 完整内置技能迁移，完整 custom DIY/OL parser 接入（已有 parser-facing summon/shadow/zombie 与组合 minion overlay 导入入口），以及更多内置 minion handler 参数化/strict-diff parity。
