...
- `RuntimeV2Runner` 已可从 bed2-only / mixed roster 构造正式 v2 runner，并输出单回合 `NormalizedOutcome` 供 strict diff / runner golden 复用。
