...
峰值上涨到 `e=46`、`h=184`、`l=1560`、`q=146`、`V=4846`、`X=3489`。把 3v2v2v1 再扩到 210000 局
（每局 8 帧，1680000 样本，413 s 生成）后 `e` 回落到 44、`V` 升到 4868——**峰值同时受对局数与每局帧数影响，
不是“对局数越多越高”的单调函数**。容量细节见
