...
胜率数据集的设计与读取契约见 [设计索引](../design/README.md) 和 [`tswn_winprob_dataset` README](../../crates/tswn_winprob_dataset/README.md)；其中 encoder 容量测量直接为 [FeatureEncoder 规格](../design/feature-encoder-spec.md) 提供依据。
